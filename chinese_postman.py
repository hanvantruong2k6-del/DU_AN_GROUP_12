...
"""
chinese_postman.py
BAI TOAN NGUOI PHAT THU TRUNG QUOC (Chinese Postman Problem / Route Inspection
Problem) - phan "nang cao thuc su" cua Phan 8: xu ly truong hop do thi KHONG
...
Y TUONG THUAT TOAN:
 ...
 6. Chay HIERHOLZER tren do thi da tang cuong de tim chu trinh Euler - day
    chinh la lo trinh toi uu ma xe quet rac / nguoi phat thu can di, bat dau
    va ket thuc tai diem xuat phat (garage), quay lai it duong nhat co the.
...
def chinese_postman(graph, start=0, verbose=False):
    """
